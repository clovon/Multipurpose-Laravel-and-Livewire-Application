<div class="-mt-6">
    <header class="px-4 lg:px-16 pt-6 pb-20 flex justify-between items-center bg-gray-100">
        ...
        <div class="mr-6 md:mr-20 lg:mr-20 flex items-center">
            ...
            <span class="ml-2 text-2xl text-gray-700 font-semibold tracking-tighter">YouTube</span>
        </div>
    ...
    <div class="-mt-12 flex flex-col justify-center items-center">
        <div class="flex flex-col justify-center items-center">
            <img src="https://yt3.ggpht.com/ytc/AAUvwnhQStkaJSFrZmeqrKRU5cgY4cnVTtPFg4iCRC3q=s900-c-k-c0x00ffffff-no-rj" class="h-20 w-20 rounded-full" />
